...
import { LayoutDashboard, Store, Users, CreditCard, BarChart3, Settings, FileText, LogOut, Menu, X, ChevronLeft, Newspaper, UserPlus } from "lucide-react";
...
const navItems = [
    ...
    { to: "/admin/users", label: "Usuários", icon: UserPlus },
