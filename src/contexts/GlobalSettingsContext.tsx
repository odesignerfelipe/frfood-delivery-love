            ...
            try {
                ...
                if (data) {
                    ...
                    const newSettings: GlobalThemeSettings = {
                        ...
                        faviconUrl: val.faviconUrl || defaultSettings.faviconUrl,
                        siteName: val.siteName || defaultSettings.siteName,
                        navbarButtonText: val.navbarButtonText || defaultSettings.navbarButtonText,
                        heroTitle: val.heroTitle || defaultSettings.heroTitle,
                        heroSubtitle: val.heroSubtitle || defaultSettings.heroSubtitle,
                        heroButtonText: val.heroButtonText || defaultSettings.heroButtonText,
                        heroImageUrl: val.heroImageUrl || defaultSettings.heroImageUrl,
                        heroBgType: val.heroBgType || defaultSettings.heroBgType,
                        heroBgColor: val.heroBgColor || defaultSettings.heroBgColor,
                        heroBadgeText: val.heroBadgeText || defaultSettings.heroBadgeText,
                        heroStats: val.heroStats || defaultSettings.heroStats,
                        pricingTitle: val.pricingTitle || defaultSettings.pricingTitle,
                        pricingSubtitle: val.pricingSubtitle || defaultSettings.pricingSubtitle,
                        monthlyPrice: val.monthlyPrice || defaultSettings.monthlyPrice,
                        yearlyPrice: val.yearlyPrice || defaultSettings.yearlyPrice,
                        ctaTitle: val.ctaTitle || defaultSettings.ctaTitle,
                        ctaSubtitle: val.ctaSubtitle || defaultSettings.ctaSubtitle,
                        ctaButtonText: val.ctaButtonText || defaultSettings.ctaButtonText,
                        faqItems: val.faqItems || defaultSettings.faqItems,
                        footerText: val.footerText || defaultSettings.footerText,
                        features: val.features || defaultSettings.features,
                    };
