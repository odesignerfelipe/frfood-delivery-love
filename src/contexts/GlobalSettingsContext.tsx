            ...
            try {
                ...
                if (data) {
                    ...
                    const newSettings: GlobalThemeSettings = {
                        ...
                        secondaryColor: row.secondary_color || val.secondaryColor || defaultSettings.secondaryColor,
                        logoUrl: row.logo_url || val.logoUrl || defaultSettings.logoUrl,
                        faviconUrl: row.favicon_url || val.faviconUrl || defaultSettings.faviconUrl,
                        siteName: row.site_name || val.siteName || defaultSettings.siteName,
                        navbarButtonText: row.navbar_button_text || val.navbarButtonText || defaultSettings.navbarButtonText,
                        heroTitle: row.hero_title || val.heroTitle || defaultSettings.heroTitle,
                        heroSubtitle: row.hero_subtitle || val.heroSubtitle || defaultSettings.heroSubtitle,
                        heroButtonText: row.hero_button_text || val.heroButtonText || defaultSettings.heroButtonText,
                        heroImageUrl: row.hero_image_url || val.heroImageUrl || defaultSettings.heroImageUrl,
                        heroBgType: row.hero_bg_type || val.heroBgType || defaultSettings.heroBgType,
                        heroBgColor: row.hero_bg_color || val.heroBgColor || defaultSettings.heroBgColor,
                        heroBadgeText: row.hero_badge_text || val.heroBadgeText || defaultSettings.heroBadgeText,
                        heroStats: row.hero_stats || val.heroStats || defaultSettings.heroStats,
                        pricingTitle: row.pricing_title || val.pricingTitle || defaultSettings.pricingTitle,
                        ...
                        faqItems: row.faq_items || val.faqItems || defaultSettings.faqItems,
                        footerText: row.footer_text || val.footerText || defaultSettings.footerText,
                        features: row.features || val.features || defaultSettings.features,
                    };
