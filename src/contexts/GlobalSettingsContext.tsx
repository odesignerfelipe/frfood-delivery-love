            ...
            try {
                ...
                if (data) {
                    ...
                    const newSettings: GlobalThemeSettings = {
                        primaryColor: val.primaryColor ?? row.primary_color ?? defaultSettings.primaryColor,
                        secondaryColor: val.secondaryColor ?? row.secondary_color ?? defaultSettings.secondaryColor,
                        logoUrl: val.logoUrl || row.logo_url || defaultSettings.logoUrl,
                        ...
                        promoMonthlyPrice: val.promoMonthlyPrice || row.promo_monthly_price || defaultSettings.promoMonthlyPrice,
                        promoYearlyPrice: val.promoYearlyPrice || row.promo_yearly_price || defaultSettings.promoYearlyPrice,
                        promoActive: val.promoActive ?? row.promo_active ?? defaultSettings.promoActive,
                        promoLabel: val.promoLabel || row.promo_label || defaultSettings.promoLabel,
